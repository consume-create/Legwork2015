data = {
  ...
  "details": {
    ...
    "overview": "Following the success of the digital marketing efforts for \"ParaNorman,\" Laika tapped the same team (W+K and us) for thier 2014 movie, \"The Boxtrolls.\" Laika's craft is an inspiration and working with them again was nothing short of a dream come true. The site lets you explore the movie and the trailer, stopping at points of interest along the way to check out games, behind the scenes content and more.",
    "services": [
      "Services",
      "Concept Development",
      "User Experience",
    ...
    "media": [
      ...
      },
      {
        ...
        "copy": {
          ...
          "text": [
            "Prior to launching the main site, we built a configurator that allowed you to \"Build your Own Boxtroll\" and submit it to an online contest. The winner recieved a handmade version of their online creation from Laika."
          ]
        },
        "images": [
