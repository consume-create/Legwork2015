...
class PageController
  ...
  *----------------------------------------###
  onMouseDown: (e) =>
    # Only start this if user is using 'left click' on desktop, or touch devices carry on
    if LW.utils.is_mobile.any() is false and e.which is 1 or LW.utils.is_mobile.any() is true
      @dragging = true
